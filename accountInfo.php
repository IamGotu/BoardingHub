...
<div class="container mt-4" style="width: 1000px;">
    <div class="row">
        <div class="col-md-6">
            <img src="" title="" style="width:50%"/>
        </div>
        <div class="col-md-6">
            <h1 style="font-size: 75px; font-family: Brush Script MT; margin-top: 30px; margin-left: -200px; text-align: center;">Boarding Hub</h1>
            ...
            while($bk = mysqli_fetch_assoc($results)): 
                ...
                ?>
                    ...
                    <div class='container mt-4' id='<?=$bkd?>' style='width: 800px; display: none;'>
                        <h1 style="font-family: Brush Script MT; font-size: 50px; text-align: center;">Boarding Hub System</h1>
